...
print(text.find('a'))  # 1
print(text.find('z'))  # -1
print(text.find('A'))   # -1   => 대소문자 구분해서 찾음
...
# =============================================================
# isalpha - 문자열이 비어 있지 않고, 모든 글자가 '문자(letter)'인가
...
# 내가 추가한 메모
# str.replace(old, new[,count]) => []는 선택인자(써도 되고 안써도 됨) / str,strip[chars] / str.split / str.jon 은 꼭 알고 있어야함

# =============================================================
# replace - 특정 부분을 다른 문자열로 교체(기잔 문자열에서 "old"라는 부분 문자열이 "new" 로 모두 바뀐 문자열 반환)
...
# =============================================================
# join(iteable) - split의 반대: 리스트를 하나의 문자열로 합침(iterable 의 문자열을 연결한 문자열을 반환)
