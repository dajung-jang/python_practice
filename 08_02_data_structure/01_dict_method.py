...
# print(person['country'])  # KeyError: 'country'       ->이렇게 쓰면 키가 없을 때 출력하지 못하고 에러가 남
...
# =============================================================
# [5] pop - 키를 제거하면서 그 값을 반환(연결 됐던 값을 반환해줌 = value)
# - .pop(dey[, default])
...
# 강사님 설명
# s.pop()
# 세트 s에서 임의의 항목을 반환하고, 해당 항목을 제거
# 임의의는 랜덤??
# 해시 테이블에 의해서 작은 값 부터 제거
...
# 문자열의 경우 해시 난수화 때문에 실행 할때마다 결과가 다르다.
